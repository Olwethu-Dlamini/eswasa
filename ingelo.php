                ...
                <div class="intro-section">
                    <div class="row align-items-start g-3">
                        ...
                        <div class="col-lg-3 col-md-4 mb-3 mb-md-0">
                            <img src="assets/img/quality/ingelo-certification-black.png" alt="Ingelo MSME Product Certification Mark" class="img-fluid rounded img-close-to-text" style="object-fit: contain; min-width: 120px; max-width: 100%;">
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        <h2 class="cta-title">Ready to Get Ingelo Certified?</h2>
                        <p class="cta-subtitle">Request a certification quote or speak to an Ingelo officer to get started.</p>
                        <a href="qoute_certification.php" class="btn-cta">Request Certification Quote</a>
                        <a href="contact.php" class="btn-cta">Speak to an Ingelo Officer</a>
                    </div>
                </div>
            </div>
        </section>
