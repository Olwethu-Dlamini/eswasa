...
<nav id="sidebar" class="bg-body border-end">
    <div class="sidebar-inner">
        <ul class="nav flex-column pt-2">
            ...
            <!-- Updates -->
            <?php $upd_pages = ['events_edit.php','vacancies_edit.php','vacancies_content.php','publications_edit.php','announcements_edit.php','faq_edit.php']; ?>
            <li class="nav-item">
                ...
                <ul class="nav flex-column ms-3 collapse <?= submenu_open($upd_pages, $current_page) ?>" id="submenu-updates">
                    ...
                    <li class="nav-item"><a class="nav-link <?= $current_page==='vacancies_content.php'?'active':'' ?>" href="index.php?page=vacancies_content.php">Vacancies — Page Content</a></li>
