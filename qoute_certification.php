                    ...
                    <form id="certQuoteForm" action="process_quote.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-section">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-text">e.g., Process flowcharts, product specs, previous audit reports <strong>PDF files only, up to 10&nbsp;MB each and 20&nbsp;MB in total, maximum 5 files.</strong></div>
                            </div>
                            <div class="mb-3">
